...
export const chatReplySchema = z.object({
  reply: z
    .string()
    .describe('要发到群里的那一条消息。口语，1-3 句，使用提问者的语言，不要客套话。'),
  suggestedQuestions: z
    .array(z.string())
    .min(2)
    .max(4)
    .describe(
      '3 个接下来可以问的问题，使用提问者的语言（中文每条不超过 18 个字，英文不超过 60 个字符），显示在所有人的输入框上方。'
    ),
});
...
- 口语，**短**。1-3 句就够，不要写成小作文。
- **用提问者的语言回答**（他说中文就中文，说英文就英文）。这是一个公开群聊，别人看到的是你的原话；
  不做翻译，也不要中英对照。
...
每次都要给 3 个「接下来别人可能想问」的问题，语言跟提问者一致。它们会显示在**所有人的**输入框上方，
